...
\begin{itemize}
\item James Dinan, \openshmem 1.5 chair, and Teams \& Contexts committee chair
\item Michael Raymond, Front Matter committee chair
\item Manju Gorentla, Library Setup, Threads, \& Memory commitee chair
\item Pavel Shamis, RMA, AMO, and Signals committee chair
\item Nick Park, Collectives committee chair
\item Naveen Ravi, Synchronization, Ordering, and Locking committee chair
\item John Linford and Wasi Rahman, Profiling committee chairs
\item Bryant Lam, Back Matter committee chair
\end{itemize}
