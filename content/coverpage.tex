...
\item James Dinan \footnote{\openshmem Document Editor} \footnote{Teams and Contexts committee chair}, NVIDIA
...
\item Bryant Lam \footnote{Back Matter committee chair}, \ac{DoD}
\item Akhil Langer, NVIDIA
\item John Linford \footnote{Profiling committee co-chair}, Arm Inc.
\item Jens Manser, \ac{DoD}
\item Tiffany M. Mintz, \ac{ORNL}
\item David Ozog, Intel
\item Nick Park \footnote{Collectives committee chair}, \ac{DoD}
\item Steve Poole \footnote{\openshmem Specification Committee Chair}, \ac{OSSS}
\item Wendy Poole, \ac{LANL}
\item Swaroop Pophale, \ac{ORNL}
\item Sreeram Potluri, NVIDIA
\item Howard Pritchard, \ac{LANL}
\item Md. Wasi-ur- Rahman \footnote{Profiling committee co-chair}, Intel
\item Naveen Ravichandrasekaran \footnote{Synchronization, Ordering, and Locking committee chair}, \ac{HPE}
\item Michael Raymond \footnote{Front Matter committee chair}, \ac{HPE}
\item James Ross, \ac{ARL}
\item Pavel Shamis \footnote{RMA, AMO, and Signals committee chair}, Arm Inc.
\item Sameer Shende, \ac{UO}
\item Min Si, \ac{ANL}
\item Manjunath Gorentla Venkata \footnote{\openshmem Specification Committee Secretary} \footnote{Library Setup, Threads, and Memory committee chair}, Mellanox
\end{itemize}
\end{multicols}
