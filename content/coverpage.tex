...
\item James Dinan_{\openshmem Document Editor}_{Teams and Contexts committee chair}, NVIDIA
...
\item Bryant Lam_{Back Matter committee chair}, \ac{DoD}
\item Akhil Langer, NVIDIA
\item John Linford_{Profiling committee co-chair}, Arm Inc.
\item Jens Manser, \ac{DoD}
\item Tiffany M. Mintz, \ac{ORNL}
\item David Ozog, Intel
\item Nick Park_{Collectives committee chair}, \ac{DoD}
\item Steve Poole_{\openshmem Specification Committee Chair}, \ac{OSSS}
\item Wendy Poole, \ac{LANL}
\item Swaroop Pophale, \ac{ORNL}
\item Sreeram Potluri, NVIDIA
\item Howard Pritchard, \ac{LANL}
\item Md. Wasi-ur- Rahman_{Profiling committee co-chair}, Intel
\item Naveen Ravichandrasekaran_{Synchronization, Ordering, and Locking committee chair}, \ac{HPE}
\item Michael Raymond_{Front Matter committee chair}, \ac{HPE}
\item James Ross, \ac{ARL}
\item Pavel Shamis_{RMA, AMO, and Signals committee chair}, Arm Inc.
\item Sameer Shende, \ac{UO}
\item Min Si, \ac{ANL}
\item Manjunath Gorentla Venkata_{\openshmem Specification Committee Secretary}_{Library Setup, Threads, and Memory committee chair}, Mellanox
\end{itemize}
\end{multicols}
