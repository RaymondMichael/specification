...
The editors and organizers of \openshmem 1.5 have been:

\begin{itemize}
\item Steve Poole, \ac{OSSS}, \openshmem Specification Committee Chair
\item Manjunath Gorentla Venkata, Mellanox, \openshmem Specification Committee Secretary
\item James Dinan, NVIDIA, \openshmem Document Editor
\end{itemize}

Section Commitee Chairs:
\begin{itemize}
\item Michael Raymond, \ac{HPE} - Front Matter
\item Manjunath Gorentla Venkata, Mellanox - Library Setup, Threads, and Memory
\item James Dinan, NVIDIA - Teams and Contexts
\item Pavel Shamis, Arm Inc. - RMA, AMO, and Signals
\item Nick Park, \ac{DoD} - Collectives
\item Naveen Ravi, \ac{HPE} - Synchronization, Ordering, and Locking
\item John Linford, Arm Inc. and Md. Wasi-ur- Rahman, Intel - Profiling
\item Bryant Lam, \ac{DoD} - Back Matter
\end{itemize}

The following list includes some of the participants in the \openshmem 1.5 effort not already mentioned.
